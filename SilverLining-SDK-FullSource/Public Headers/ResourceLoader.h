...
public:
/// Constructor.
    ResourceLoader() : resourcePath(0), resourceDllPath(0) {
    }
...
/// Sets the path to the SilverLining renderer DLL's, normally located within the VC*/win32 or VC*/x64 subdiretories
/// of the resources directory. If you want to build and manage your own renderer DLL's in a separate location,
/// call this to specify their location. To retain default behavior, do not call this at all.
