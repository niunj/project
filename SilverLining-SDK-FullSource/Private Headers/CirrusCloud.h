...
public:
/** Default constructor. */
    CirrusCloud(CloudLayer *layer, double coverageThreshold);
 ...
 */
    virtual void Init(double w, double h, const RandomNumberGenerator* rng, ThreadCameraStreamData* tcsData);
