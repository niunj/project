...
namespace SilverLining
{
    namespace Vulkan
    {
        namespace vkInitializers
        {
            ...
            inline VkDescriptorPoolCreateInfo descriptorPoolCreateInfo(
                const SL_VECTOR(VkDescriptorPoolSize)& poolSizes,
                uint32_t maxSets)
            {
                VkDescriptorPoolCreateInfo descriptorPoolInfo{};
                descriptorPoolInfo.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
            ...
            inline VkDescriptorSetLayoutCreateInfo descriptorSetLayoutCreateInfo(
                const SL_VECTOR(VkDescriptorSetLayoutBinding)& bindings)
            {
                VkDescriptorSetLayoutCreateInfo descriptorSetLayoutCreateInfo{};
                descriptorSetLayoutCreateInfo.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO;
            ...
            inline VkPipelineVertexInputStateCreateInfo pipelineVertexInputStateCreateInfo(
                const SL_VECTOR(VkVertexInputBindingDescription)& vertexBindingDescriptions,
                const SL_VECTOR(VkVertexInputAttributeDescription)& vertexAttributeDescriptions
            )
            {
                VkPipelineVertexInputStateCreateInfo pipelineVertexInputStateCreateInfo{};
                pipelineVertexInputStateCreateInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
            ...
            inline VkPipelineDynamicStateCreateInfo pipelineDynamicStateCreateInfo(
                const SL_VECTOR(VkDynamicState)& pDynamicStates,
                VkPipelineDynamicStateCreateFlags flags = 0)
            {
                VkPipelineDynamicStateCreateInfo pipelineDynamicStateCreateInfo{};
                pipelineDynamicStateCreateInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO;
            ...
            /** @brief Initialize a specialization constant info structure to pass to a shader stage */
            inline VkSpecializationInfo specializationInfo(const SL_VECTOR(VkSpecializationMapEntry)& mapEntries, size_t dataSize, const void* data)
            {
                VkSpecializationInfo specializationInfo{};
