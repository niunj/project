...
void BufferGL::InitBuffers(void)
{
    ...
    glBindBuffer(glBufferType, glHandle);
...
void BufferGL::DeInitBuffers(void* _context)
{
    ...
    actualStream->glBindBuffer(glBufferType, this);
    glNamedBufferData(glHandle, 0, NULL, GL_DYNAMIC_DRAW);
    actualStream->glBindBuffer(glBufferType, (BufferGL*)0);

    actualStream->glDeleteBuffer(glHandle);
    glHandle = 0;
