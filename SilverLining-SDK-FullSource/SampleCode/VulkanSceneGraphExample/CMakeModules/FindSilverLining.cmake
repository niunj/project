...
IF (MSVC_TOOLSET_VERSION EQUAL 143)
	IF (CMAKE_CL_64)
		SET(SILVERLINING_ARCH "vc143/x64")
	ELSE (CMAKE_CL_64)
		SET(SILVERLINING_ARCH "vc143/win32")
	ENDIF (CMAKE_CL_64)
ENDIF (MSVC_TOOLSET_VERSION EQUAL 143)
...
FIND_PATH(SILVERLINING_INCLUDE_DIR Atmosphere.h
	"C:/Users/James/Poojan/Projects/sundog/silverlining/Public Headers"
...
MACRO(FIND_SILVERLINING_LIBRARY MYLIBRARY MYLIBRARYNAME)
    ...
    NAMES ${MYLIBRARYNAME}
    PATHS
		"C:/Users/James/Poojan/Projects/sundog/silverlining/lib"
...
FIND_SILVERLINING_LIBRARY(SILVERLINING_LIBRARY_RELEASE "SilverLining-MT-DLL;SilverLining;SilverLiningVulkan")
FIND_SILVERLINING_LIBRARY(SILVERLINING_LIBRARY_DEBUG "SilverLining-MTD-DLL;SilverLiningVulkan")
