...
// Copyright (c) 2006-2014 Sundog Software. All rights reserved worldwide.
...
static float windMultiplier = 1.0;
...
void Display()
{
    ...
    glLoadIdentity();
    gluPerspective(30.0, aspectRatio, 2, 100000);

    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
    glRotatef(pitch, 1, 0, 0);
    glRotatef(yaw, 0, 1, 0);
    glTranslatef(0, -100, translation);
...
void SetupOpenGL()
{
    ...
    windowHandle = glutCreateWindow("SilverLining OpenGL Example");
...
#endif
{
    ...
    if (err == Atmosphere::E_NOERROR) {
        ...
        atm->GetRandomNumberGenerator()->Seed(0);

#ifndef WIN32
        // Ubuntu 13.10 / Intel drivers have problems with the more complicated
        // sky shader
        atm->SetSkyModel(PREETHAM);
#endif
